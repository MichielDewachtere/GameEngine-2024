...
real::SpriteComponent::~SpriteComponent()
{
...
void real::SpriteComponent::Render()
{
...
void real::SpriteComponent::OnSubjectDestroy()
{
	GetOwner()->GetTransform()->worldPosChanged.RemoveObserver(this);
}
...
void real::SpriteComponent::PlayAnimation(int startIdx, int endIdx, int loops, float timePerAnimation)
{
...
void real::SpriteComponent::PlayAnimation(const std::vector<int>& idcs, int loops, float timePerAnimation)
{
...
void real::SpriteComponent::UpdateAnimation(int startIdx, int endIdx, int loops, float timePerAnimation)
{
	m_AccuTime = 0.f;
...
glm::ivec2 real::SpriteComponent::GetSpriteSheetSize() const
{
